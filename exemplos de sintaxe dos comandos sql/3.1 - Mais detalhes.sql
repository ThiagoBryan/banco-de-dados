...
-- Mais funções de texto
Select DataLength('458')
Select Len('458')
                               1234567890123456
-- Me mostra a posição inicial de um texto passado por parâmetro
Select CharIndex('audiência', 'O documento da audiência está sobre a mesa')

-- Substitui no texto original o texto passado por parâmetro por um novo texto
Select Replace('O documento da audiência está sobre a mesa', 'da audiência', 'do fórum')
Select Replace('O documento da audiência está sobre a mesa', 'da janela', 'do fórum')
